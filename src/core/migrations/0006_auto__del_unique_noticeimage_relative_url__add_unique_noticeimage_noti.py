...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'NoticeImage', fields ['relative_url']
        db.delete_unique(u'core_noticeimage', ['relative_url'])  # @UndefinedVariable

        # Adding unique constraint on 'NoticeImage', fields ['notice', 'relative_url']
        db.create_unique(u'core_noticeimage', ['notice_id', 'relative_url'])  # @UndefinedVariable


    def backwards(self, orm):
        # Removing unique constraint on 'NoticeImage', fields ['notice', 'relative_url']
        db.delete_unique(u'core_noticeimage', ['notice_id', 'relative_url'])  # @UndefinedVariable

        # Adding unique constraint on 'NoticeImage', fields ['relative_url']
        db.create_unique(u'core_noticeimage', ['relative_url'])  # @UndefinedVariable
