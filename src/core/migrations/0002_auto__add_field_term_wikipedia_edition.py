...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Term.wikipedia_edition'
        db.add_column(u'core_term', 'wikipedia_edition',  # @UndefinedVariable
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Term.wikipedia_edition'
        db.delete_column(u'core_term', 'wikipedia_edition')  # @UndefinedVariable
