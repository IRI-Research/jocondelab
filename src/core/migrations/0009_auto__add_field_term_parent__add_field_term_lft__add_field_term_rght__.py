...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Term.parent'
        db.add_column(u'core_term', 'parent',  # @UndefinedVariable
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['core.Term']),
                      keep_default=False)

        # Adding field 'Term.lft'
        db.add_column(u'core_term', u'lft',  # @UndefinedVariable
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Term.rght'
        db.add_column(u'core_term', u'rght',  # @UndefinedVariable
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Term.tree_id'
        db.add_column(u'core_term', u'tree_id',  # @UndefinedVariable
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Term.level'
        db.add_column(u'core_term', u'level',  # @UndefinedVariable
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Term.parent'
        db.delete_column(u'core_term', 'parent_id')  # @UndefinedVariable

        # Deleting field 'Term.lft'
        db.delete_column(u'core_term', u'lft')  # @UndefinedVariable

        # Deleting field 'Term.rght'
        db.delete_column(u'core_term', u'rght')  # @UndefinedVariable

        # Deleting field 'Term.tree_id'
        db.delete_column(u'core_term', u'tree_id')  # @UndefinedVariable

        # Deleting field 'Term.level'
        db.delete_column(u'core_term', u'level')  # @UndefinedVariable
