...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Term.link_semantic_level'
        db.add_column(u'core_term', 'link_semantic_level',  # @UndefinedVariable
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Term.link_semantic_level'
        db.delete_column(u'core_term', 'link_semantic_level')  # @UndefinedVariable
