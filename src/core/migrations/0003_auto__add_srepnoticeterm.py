...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SrepNoticeTerm'
        db.create_table(u'core_srepnoticeterm', (  # @UndefinedVariable
        ...
        db.send_create_signal('core', ['SrepNoticeTerm'])  # @UndefinedVariable


    def backwards(self, orm):
        # Deleting model 'SrepNoticeTerm'
        db.delete_table(u'core_srepnoticeterm')  # @UndefinedVariable
