...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Term.nb_notice'
        db.add_column(u'core_term', 'nb_notice',  # @UndefinedVariable
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Term.nb_notice'
        db.delete_column(u'core_term', 'nb_notice')  # @UndefinedVariable
