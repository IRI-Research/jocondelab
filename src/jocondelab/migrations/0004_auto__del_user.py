...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        orm['contenttypes.contenttype'].objects.filter(app_label='jocondelab', model='user', name='user').update(app_label='core', model='user', name='user')

    # does nothing all has been put in core migration (0010_auto__add_user__chg_field_term_validator)
    def backwards(self, orm):
        orm['contenttypes.contenttype'].objects.filter(app_label='core', model='user', name='user').update(app_label='jocondelab', model='user', name='user')
