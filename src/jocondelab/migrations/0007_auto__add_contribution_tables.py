...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContributedFields'
        db.create_table(u'jocondelab_contributedfields', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dbpedia_fields', to=orm['jocondelab.ContributedTerm'])),
        ...
        db.send_create_signal('jocondelab', ['ContributedFields'])

        # Adding model 'Contribution'
        db.create_table(u'jocondelab_contribution', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('term', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contributions', to=orm['jocondelab.ContributedTerm'])),
            ...
            ('contribution_count', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
        ))
        db.send_create_signal('jocondelab', ['Contribution'])

        # Adding model 'ContributedTerm'
        db.create_table(u'jocondelab_contributedterm', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('dbpedia_uri', self.gf('django.db.models.fields.URLField')(unique=True, max_length=2048, db_index=True)),
            ('dbpedia_language', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
        ))
        db.send_create_signal('jocondelab', ['ContributedTerm'])


    def backwards(self, orm):
        # Deleting model 'ContributedFields'
        db.delete_table(u'jocondelab_contributedfields')

        # Deleting model 'Contribution'
        db.delete_table(u'jocondelab_contribution')

        # Deleting model 'ContributedTerm'
        db.delete_table(u'jocondelab_contributedterm')
